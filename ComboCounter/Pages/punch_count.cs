...
namespace ComboCounter.UserControls
{
    public partial class punch_count : BaseFormControl
    {
        ...
        // Timer to keep track of the time for the current time display
        ...
        /// <summary>
        /// Called whenever the last hit display changes
        /// Processes how hard the hit was to change the color of the text
        /// </summary>
        ...
        /// <summary>
        /// Gets the most recent values for the settings 
        /// Just in case the user visited the UserSettings page
        /// </summary>
